...
export  const findTeacherClicked = inputData => dispatch => {
  fetch('https://z9a1i9pu6i.execute-api.us-east-1.amazonaws.com/dev/getTutor/username/' + inputData, {
    method: 'GET'
  })
    .then(res => res.json())
    .then(data =>
...
export  const findStudentClicked = inputData => dispatch => {
  fetch('https://z9a1i9pu6i.execute-api.us-east-1.amazonaws.com/dev/getStudent/username/' + inputData, {
    method: 'GET'
  })
    .then(res => res.json())
    .then(data =>
